...
import { Bot, Mail, Lock, Loader2, AlertTriangle, Eye, EyeOff } from "lucide-react";
    ...
    <div className="w-full max-w-md p-8 rounded-2xl border border-slate-800 bg-slate-900/60 backdrop-blur-xl shadow-2xl relative overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center mb-8 relative z-10">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-white mb-1.5">
          Welcome to TalentVault AI
        </h2>
        <p className="text-sm text-slate-400">
          Enter credentials to access the AI Talent Vault
        </p>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              {...register("password")}
              disabled={isSubmitting}
              className={`w-full h-12 pl-11 pr-11 rounded-xl border bg-slate-950/60 text-sm text-slate-100 placeholder-slate-500 focus:outline-none transition-all ${
                errors.password
                  ? "border-red-500/50 focus:border-red-500"
                  : "border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
              }`}
